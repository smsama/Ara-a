...
void loop() {
  ...
  /*
  Serial.println("UP_FRONT_IZQ");
  upFrontIzq.write(100);
  delay(1000);

  Serial.println("MOV_FRONT_IZQ");
  movFrontIzq.write(100);
  delay(1000);

  Serial.println("UP_BACK_IZQ");
  upBackIzq.write(100);
  delay(1000);

  Serial.println("MOV_BACK_IZQ");
  movBackIzq.write(100);
  delay(1000);

  Serial.println("UP_FRONT_DER");
  upFrontDer.write(100);
  delay(1000);
*/
  Serial.println("MOV_FRONT_DER");
  //movFrontDer.write(100);
  //delay(2000);
  //movFrontDer.write(180);
  //delay(2000);
  movFrontDer.write(360);
/*
  Serial.println("UP_BACK_DER");
  upBackDer.write(100);
  delay(1000);

  Serial.println("MOV_BACK_DER");
  movBackDer.write(100);
  delay(1000);*/
}
